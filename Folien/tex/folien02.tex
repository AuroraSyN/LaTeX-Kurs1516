...
\end{lstlisting}
\begin{itemize}
\item Argumente werden mit |[3]| definiert
...
\begin{matrix}
	...
	\text{\hspace{12em}}
\end{matrix}
\right\rbrace\text{\parbox{9em}{Typografisch unschön, nur für Handschriften}}$
\vspace*{-2.9ex}
}
...
\begin{frame}{Weiterführende Literatur}
	\begin{thebibliography}{9}
		\bibitem{voss} \textsc{Herbert Voss}:
			\newblock{\href{http://mirrors.ctan.org/info/math/voss/mathmode/Mathmode.pdf}{„Math mode“}}, 
			\newblock{\href{http://mirrors.ctan.org/info/math/voss/mathmode/Mathmode.pdf}{\texttt{texdoc mathmode}}}.
		\bibitem{amsmath} \textsc{American Mathematical Society}:
			\newblock{\href{http://mirrors.ctan.org/info/math/}{„User’s Guide for the \texttt{amsmath} Package“}}, 
			\newblock{\href{http://mirrors.ctan.org/info/math/}{\texttt{texdoc amsmath}}}.
	\end{thebibliography}
\end{frame}
